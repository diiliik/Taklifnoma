...
const targetWeddingDate = new Date("2026-06-26T18:00:00+05:00").getTime();
...
const LOCALES = {
  ru: {
    pageTitle: "Дилшода и Диноры | Свадебное приглашение",
    metaDescription: "Свадебное приглашение Дилшода и Диноры на 26 июня 2026 года.",
    previewImageAlt: "Свадебное приглашение Дилшода и Диноры",
    ariaIntro: "Экран открытия приглашения",
    ariaEnvelope: "Запечатанный бумажный конверт",
    ariaWeddingDate: "Дата свадьбы",
    ariaCalendar: "Календарь июня 2026 с выделенным 26 июня",
    ...
    openHere: "нажмите",
    lead: "С огромной радостью и теплотой в сердце приглашаем вас разделить с нами самый счастливый день в жизни наших детей.<br /><br />Будем счастливы разделить радость этого особенного момента вместе с вами.<br /><br /><strong>С любовью приглашаем вас на нашу свадьбу.</strong>",
    ...
    venueName: "Дворец торжеств «Икбол»",
    venueAddress: "Адрес: Мирабадский район, 9-й пр. Файзиабад, 5/1.",
  ...
  uz: {
    pageTitle: "Dilshod va Dinora | To'y taklifnomasi",
    metaDescription: "Dilshod va Dinora 2026-yil 26-iyun kungi to'y taklifnomasi.",
    previewImageAlt: "Dilshod va Dinora to'y taklifnomasi",
    ariaIntro: "Taklifnomani ochish ekrani",
    ariaEnvelope: "Muhrlangan qog'oz konvert",
    ariaWeddingDate: "To'y sanasi",
    ariaCalendar: "2026-yil iyun kalendari, 26-iyun belgilangan",
    ...
    openHere: "ochish",
    lead: "Hayotimizdagi eng baxtli kunlardan biri - farzandlarimiz nikoh to'yini siz bilan birga nishonlashni niyat qildik.<br /><br />Sizni ushbu kechamizga samimiy taklif etamiz.<br /><br />Quvonchli kunimizda aziz mehmonimiz bo'ling.<br /><br /><strong>Hurmat bilan Rasulovlar oilasi.</strong>",
    ...
    venueName: "\"Iqbol\" tantanalar saroyi",
    venueAddress: "Manzil: Mirobod tumani, Fayziobod 9-tor koʻchasi, 5/1.",
